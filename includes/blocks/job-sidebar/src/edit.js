...
export default function Edit() {
	...
	const jobData = {
		...
		category: 'Marketing',
		skills: ['Content Marketing', 'Non-Tech', 'Social Media Marketing', 'Social Proof Tools']
	};
	...
	return (
		<div {...useBlockProps()} className="job-sidebar">
			...
			<div className="company-header">
				<img src={jobData.company.logo} alt={jobData.company.name} className="company-logo" />
			...
			<div className="job-details">
				...
				<div className="detail-item">
					...
					<div>
						...
						<p>{jobData.location.remote ? 'Remote' : ''} {jobData.location.regions.join(', ')}</p>
					</div>
				</div>
			...
			{/* Company Website */}
			<a href={jobData.company.website} className="company-website" target="_blank" rel="noopener noreferrer">
