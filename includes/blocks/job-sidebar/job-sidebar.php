        ...
        <div class="job-sidebar-content">
            ...
            ?>
                <div class="job-company">
                    <h4><?php esc_html_e('Company', 'remote-jobs'); ?></h4>
            ...
            ?>
                <div class="job-salary">
                    <h4><?php esc_html_e('Salary Range', 'remote-jobs'); ?></h4>
            ...
            <?php else : ?>
                <div class="job-apply">
                    <p class="no-link-message"><?php esc_html_e('Application link not available yet', 'remote-jobs'); ?></p>
                </div>
            <?php endif; ?>
...
function enqueue_job_sidebar_assets() {
    if (has_block('wp-remote-jobs/job-side-bar')) {
        wp_enqueue_style(
...
add_action('enqueue_block_assets', 'enqueue_job_sidebar_assets');